...
# SECRET_ANALYTICS_KEYWORD = "letmein123" # Removed as per edit hint
...
def analytics():
    try:
        # Always show analytics, no secret keyword required
        # --- Begin analytics logic (previously inside POST/keyword check) ---
